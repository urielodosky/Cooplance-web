                ...
                <form onSubmit={handleSubmit} className="register-form">
                    ...
                    {role === 'freelancer' && (
                        <>
                            ...
                            <textarea name="bio" placeholder="Cuéntanos sobre ti (Biografía)" rows="3" onChange={handleChange} required />
                    ...
                    {role === 'company' && (
                        <>
                            ...
                            <textarea name="bio" placeholder="Biografía / Descripción de la Empresa" rows="3" onChange={handleChange} required />
                    ...
                    <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginBottom: '0.25rem' }}>Proporciona al menos un método de contacto:</p>
                    <input type="email" name="email" placeholder="Correo Electrónico" onChange={handleChange} />
                    <input type="tel" name="phone" placeholder="Teléfono (para verificación SMS)" onChange={handleChange} />
