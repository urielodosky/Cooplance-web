                    ...
                    <div style={{ flex: 1, minWidth: '300px' }}>
                        ...
                        <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap', marginBottom: '2rem' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 16px', background: 'rgba(255,255,255,0.03)', borderRadius: '12px', border: '1px solid var(--border)' }}>
                                ...
                                <span style={{ fontSize: '0.95rem', color: 'var(--text-primary)' }}>{[client.city, client.province, client.country].filter(Boolean).join(', ') || 'Planeta Tierra'}</span>
                            </div>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '8px 16px', background: 'rgba(255,255,255,0.03)', borderRadius: '12px', border: '1px solid var(--border)' }}>
                                    ...
                                    <div style={{ display: 'flex', gap: '1.25rem', alignItems: 'center' }}>
                                        <div style={{
                                            ...
                                            {job.provider?.avatar_url ? (
                                                ...
                                                <span style={{ color: 'white', fontWeight: 'bold', fontSize: '1.2rem' }}>{job.provider?.username?.charAt(0).toUpperCase()}</span>
                                            )}
                                        </div>
                                        <div>
                                            ...
                                            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.2rem' }}>
                                                ...
                                                <span 
                                                    onClick={() => navigate(`/freelancer/${job.provider?.id}`)}
